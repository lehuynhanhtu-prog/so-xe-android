const CACHE='so-xe-github-v16';
const ASSETS=['./','./index.html','./styles.css?v=16','./app.js?v=16','./privacy.html','./terms.html','./manifest.webmanifest','./icons/icon.svg','./downloads/So-Xe-iOS.mobileconfig'];
