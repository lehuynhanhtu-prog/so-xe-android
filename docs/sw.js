const CACHE='so-xe-github-v24';
const ASSETS=['./','./index.html','./downloads.html','./styles.css?v=21','./app.js?v=23','./privacy.html','./terms.html','./manifest.webmanifest','./icons/icon.svg','./downloads/So-Xe-iOS.mobileconfig'];
