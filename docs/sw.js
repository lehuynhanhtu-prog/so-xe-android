const CACHE='so-xe-github-v25';
const ASSETS=['./','./index.html','./downloads.html','./styles.css?v=21','./app.js?v=24','./privacy.html','./terms.html','./manifest.webmanifest','./icons/icon.svg','./downloads/So-Xe-iOS.mobileconfig'];
