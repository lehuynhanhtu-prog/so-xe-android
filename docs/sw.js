const CACHE='so-xe-github-v17';
const ASSETS=['./','./index.html','./downloads.html','./styles.css?v=17','./app.js?v=17','./privacy.html','./terms.html','./manifest.webmanifest','./icons/icon.svg','./downloads/So-Xe-iOS.mobileconfig'];
