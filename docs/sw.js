const CACHE='so-xe-github-v19';
const ASSETS=['./','./index.html','./downloads.html','./styles.css?v=17','./app.js?v=19','./privacy.html','./terms.html','./manifest.webmanifest','./icons/icon.svg','./downloads/So-Xe-iOS.mobileconfig'];
