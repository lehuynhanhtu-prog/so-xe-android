const CACHE='so-xe-github-v15';
const ASSETS=['./','./index.html','./styles.css?v=15','./app.js?v=15','./privacy.html','./terms.html','./manifest.webmanifest','./icons/icon.svg','./downloads/So-Xe-iOS.mobileconfig'];
