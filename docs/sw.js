const CACHE='so-xe-github-v23';
const ASSETS=['./','./index.html','./downloads.html','./styles.css?v=21','./app.js?v=22','./privacy.html','./terms.html','./manifest.webmanifest','./icons/icon.svg','./downloads/So-Xe-iOS.mobileconfig'];
