const CACHE='so-xe-github-v20';
const ASSETS=['./','./index.html','./downloads.html','./styles.css?v=17','./app.js?v=20','./privacy.html','./terms.html','./manifest.webmanifest','./icons/icon.svg','./downloads/So-Xe-iOS.mobileconfig'];
